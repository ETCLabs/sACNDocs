...
<tagfile doxygen_version="1.9.1" doxygen_gitid="ef9b20ac7f8a8621fcfc299f8bd0b80422390f4b">
  ...
  <compound kind="page">
    ...
    <docanchor file="additional_documentation.html">md__tmp_tmpfpyaypok_docs_pages_additional_documentation</docanchor>
  </compound>
  <compound kind="page">
    ...
    <docanchor file="building_and_integrating.html">md__tmp_tmpfpyaypok_docs_pages_building_and_integrating</docanchor>
  </compound>
  <compound kind="page">
    ...
    <docanchor file="configuring_lwip.html">md__tmp_tmpfpyaypok_docs_pages_configuring_lwip</docanchor>
  </compound>
  <compound kind="page">
    <name>getting_started</name>
    <title>Getting Started with sACN</title>
    <filename>getting_started.html</filename>
    <docanchor file="getting_started.html">md__tmp_tmpfpyaypok_docs_pages_getting_started</docanchor>
  </compound>
  <compound kind="page">
    ...
    <docanchor file="global_init_and_destroy.html">md__tmp_tmpfpyaypok_docs_pages_global_init_and_destroy</docanchor>
  </compound>
  <compound kind="page">
    <name>per_address_priority</name>
    <title>Per Address Priority</title>
    <filename>per_address_priority.html</filename>
    <docanchor file="per_address_priority.html">md__tmp_tmpfpyaypok_docs_pages_per_address_priority</docanchor>
  </compound>
  <compound kind="page">
    <name>source_loss_behavior</name>
    <title>Source Loss Behavior</title>
    <filename>source_loss_behavior.html</filename>
    <docanchor file="source_loss_behavior.html">md__tmp_tmpfpyaypok_docs_pages_source_loss_behavior</docanchor>
  </compound>
  <compound kind="page">
    <name>using_dmx_merger</name>
    <title>Using the sACN DMX Merger API</title>
    <filename>using_dmx_merger.html</filename>
    <docanchor file="using_dmx_merger.html">md__tmp_tmpfpyaypok_docs_pages_using_dmx_merger</docanchor>
  </compound>
  <compound kind="page">
    <name>using_merge_receiver</name>
    <title>Using the sACN Merge Receiver API</title>
    <filename>using_merge_receiver.html</filename>
    <docanchor file="using_merge_receiver.html">md__tmp_tmpfpyaypok_docs_pages_using_merge_receiver</docanchor>
  </compound>
  <compound kind="page">
    <name>using_receiver</name>
    <title>Using the sACN Receiver API</title>
    <filename>using_receiver.html</filename>
    <docanchor file="using_receiver.html">md__tmp_tmpfpyaypok_docs_pages_using_receiver</docanchor>
  </compound>
  <compound kind="page">
    <name>using_source</name>
    <title>Using the sACN Source API</title>
    <filename>using_source.html</filename>
    <docanchor file="using_source.html">md__tmp_tmpfpyaypok_docs_pages_using_source</docanchor>
  </compound>
  <compound kind="page">
    <name>index</name>
